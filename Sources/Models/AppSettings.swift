...
final class AppSettings {
    ...
    private enum Keys {
        static let language = "mluva.language"
        static let noiseReduction = "mluva.noiseReduction"
        static let removeFiller = "mluva.removeFiller"
        static let hasCompletedSetup = "mluva.hasCompletedSetup"
        static let hotkeyKeyCode = "mluva.hotkeyKeyCode"
        static let hotkeyModifiers = "mluva.hotkeyModifiers"
        static let providerPreference = "mluva.providerPreference"
        static let transcriptionMode = "mluva.transcriptionMode"
        static let cloudRecognitionAllowed = "mluva.cloudRecognitionAllowed"
        static let preferCloudForTechnicalSpeech = "mluva.preferCloudForTechnicalSpeech"
        static let requiresOnDeviceAppleSpeech = "mluva.requiresOnDeviceAppleSpeech"
        static let googleCloudProjectID = "mluva.googleCloudProjectID"
        static let googleCloudLocation = "mluva.googleCloudLocation"
        static let googleCloudModel = "mluva.googleCloudModel"
        static let googleServiceAccountFilePath = "mluva.googleServiceAccountFilePath"
        static let audioRetentionPolicy = "mluva.audioRetentionPolicy"
        static let incognitoMode = "mluva.incognitoMode"
        static let faithfulEnhancementEnabled = "mluva.faithfulEnhancementEnabled"
        static let cleanupProviderID = "mluva.cleanupProviderID"
        static let rememberLastStylePerApplication = "mluva.rememberLastStylePerApplication"
        static let rememberLastModePerApplication = "mluva.rememberLastModePerApplication"
        static let rememberProviderPerApplication = "mluva.rememberProviderPerApplication"
        static let contextualFormattingEnabled = "mluva.contextualFormattingEnabled"
        static let contextDisabledBundleIdentifiers = "mluva.contextDisabledBundleIdentifiers"
        static let historyRetentionDays = "mluva.historyRetentionDays"
        static let typedSnippetExpansionEnabled = "mluva.typedSnippetExpansionEnabled"
    }
