...
| Kit symbol | Upstream file |
| --- | --- |
| Home | Adwaita/symbolic/actions/go-home-symbolic.svg |
| Menu | Adwaita/symbolic/actions/open-menu-symbolic.svg |
| Settings | Adwaita/symbolic/categories/preferences-system-symbolic.svg |
| Minimize | Adwaita/symbolic/ui/window-minimize-symbolic.svg |
| Maximize | Adwaita/symbolic/ui/window-maximize-symbolic.svg |
| Close | Adwaita/symbolic/ui/window-close-symbolic.svg |
| Down | Adwaita/symbolic/ui/pan-down-symbolic.svg |
| Copy | Adwaita/symbolic/actions/edit-copy-symbolic.svg |
...
Water footage is [Mixkit — Close-Up of Lagoon Ripples](https://mixkit.co/free-stock-video/close-up-of-lagoon-ripples-101181/), used under the [Mixkit Stock Video Free License](https://mixkit.co/license/#videoFree). The private production handoff contains a 10-second loop; this repository records provenance rather than redistributing a stock library. The procedural Blender breathing asset is original artwork.

Desktop assets are actual captures of an isolated [Omarchy ARM VM](https://github.com/ggalancs/omarchy-arm-utm), with [Omarchy](https://github.com/basecamp/omarchy), Chromium, [Ghostty](https://github.com/ghostty-org/ghostty) and Herdr. Official theme backgrounds remain their respective owners’ artwork and are not claimed as public domain. [Capture provenance](capture-provenance.json) records environment versions, source hashes and checked behavior. Example text is synthetic; no private work, successful agent-run claim, source recording or voice asset is bundled in this public package.
