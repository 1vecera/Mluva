...
| Recording | A fixed-center red light grows and shrinks around its six-pixel midpoint on a 2.6-second cycle. The visible label is a timer; accessible names retain recording state and the Stop action. Reduced motion keeps a static light. |
