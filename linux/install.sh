...
install -m 0644 "${source_dir}/mluva_linux/"*.py \
    "${source_dir}/mluva_linux/local_models.json" \
    "${source_dir}/mluva_linux/qwen_runtime.json" \
    "${source_dir}/mluva_linux/gpu-requirements.txt" "${application_dir}/mluva_linux/"
