...
Canonical brand hues come from :mod:`mluva_linux.brand`; all remaining
...
from mluva_linux.brand import BRAND_ACTION, BRAND_INK, BRAND_SIGNAL, BRAND_SURFACE
...
def build_shell_stylesheet(tokens: dict[str, str] = DarkTokens) -> str:
    ...
    return f"""/* Generated from mluva_linux.theme; do not edit. */
.mluva-recording-bar {{
