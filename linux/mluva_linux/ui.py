...
from mluva_linux.brand import PRODUCT_NAME
from mluva_linux.feature_maturity import FeatureMaturity, feature_capability
from mluva_linux.recording_control import RecordingLight
from mluva_linux.theme import NAV_RAIL_WIDTH
...
def brand_mark(size: int) -> Gtk.Image:
    ...
    path = Path(__file__).parents[1] / "gnome-extension/recording-status@mluva.local/mluva-symbolic.svg"
